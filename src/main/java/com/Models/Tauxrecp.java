...
public class Tauxrecp {
    ...
    public double getFraisRet() {
        return fraisRet;
    }

    public void setFraisRet(double fraisRet) {
        this.fraisRet = fraisRet;
    }

    @Override
    public String toString() {
        return "Tauxrecp{" + "id=" + id + ", montant_min=" + montant_min + ", montant_max=" + montant_max + ", fraisRet=" + fraisRet + '}';
    }
