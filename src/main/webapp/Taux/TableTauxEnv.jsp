...
<div id="last-users">
    <div class="flex items-center justify-between">
        <h1 class="font-bold text-xl  uppercase">Liste des toutes taux d'envoie</h1>
                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-700 bg-gray-800">
                        <%
                            ...
                            List<Tauxenv> tauxList = dao.getAllTauxEnv();
                            for (Tauxenv cc : tauxList) {
                        %>
                            ...
                            <td class="px-4 py-3 text-base">
                                <div class="flex items-center justify-around">
                                    ...
                                    <form id="delete-form-<%= cc.getId()%>" action="deleteTaux" method="post">
                                        <input type="hidden" name="id" value="<%= cc.getId()%>">
                                        <input type="hidden" name="type" value="envoie">
