                ...
                <div class="bg-white/10 col-span-9 rounded-lg p-6">
                    <div class="col-span-9">
                        <label class="text-white">
                            <input type="radio" id="radioTauxEnv" name="toggleContent" onclick="showContent('content')" class="mr-2"> Voir Transaction Envoyer
                        </label>
                        <label class="text-white ml-4">
                            <input type="radio" id="radioTauxRet" name="toggleContent" onclick="showContent('content1')" class="mr-2"> Voir Transaction Retrait
                        </label>
                    </div>
                    <div id="content">
                        <%@include file="Transaction/TableEnvoyer.jsp"%>
                    </div>
                    <div id="content1">
                        <%@include file="Transaction/TableRetrait.jsp"%>
                    </div>
                </div>
            </div>
        </div>
