        ...
        <div class="flex items-center justify-center h-screen relative  overflow-hidden">
            ...
            <div class="min-w-[400px] relative flex-col z-10 border bg-white px-6 py-14 shadow-md rounded-xl">
                ...
                <form @submit.prevent="login()">
                    <div class="flex flex-col text-sm rounded-md">
                        ...
                        <div class="mb-4 flex flex-col">
                            ...
                            <div class="relative z-0">
                                <input type="text" name="name" 
                                       class="peer block w-full appearance-none border-b-2  bg-transparent py-2.5 px-0 text-sm  border-gray-500 focus:outline-none focus:ring-0"
                                       placeholder="" />
                                <label class="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 text-gray-500  transform text-sm duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-blue-600 ">
                                    Numéro telephone<span  class="text-red-500">*</span></label>
                            </div>
                            <p class="text-red-500 text-xs  mb-3 font-helo">Erreur sur input</p>
                        </div>
                        ...
                        <div class="mb-4 flex flex-col">
                            ...
                            <p class="text-red-500 text-xs mb-3">Erreur sur input</p>
                        </div>
                ...
                <div class="mt-2 flex justify-center text-center text-[#2f7c89]">
                    <a href="register.jsp">Créer un nouveaux compte?</a>
                </div>
            </div>
        </div>
